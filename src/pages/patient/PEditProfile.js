...
export default function PEditProfile() {

    const location = useLocation()
    const {patientdetails} = location.state
    const navigate = useNavigate()
    const bg = patientdetails.bloodGroup == null ? 'ABPOSITIVE' :patientdetails.bloodGroup
    const gen = patientdetails.gender == null ? 'MALE' :patientdetails.gender

    const [patientId, setPatientId] = useState(patientdetails.patientId)
    ...
    const [dob, setDob] = useState(patientdetails.dateOfBirth)
    const [buildingName, setBuildingName] = useState(patientdetails.buildingName)
    const [streetName, setStreetName] = useState(patientdetails.streetName)
    ...
    const [securityQuestion, setSecurityQuestion] = useState(patientdetails.securityQuestion)
    const [securityAnswer, setSecurityAnswer] = useState(patientdetails.securityAnswer)
    ...
    const editProfile=()=>{
        ...
        const body = {firstname,lastname,phone,email,bloodGroup,gender,buildingName,dateOfBirth:dob,streetName,city,state,pinCode}
    ...
    if((firstname.length === 0) && (lastname.length === 0)&& (dob.length === 0)&&(phone.length === 0) &&(gender.length === 0)
    ) {
    ...
    } else
    {
        ...
        axios.put(config.serverURL + `/patient/editprofile/${sessionStorage['userId']}`,body,header)    
        .then((response) => {
            console.log(response)
            toast.success("Profile edited successfully!!!")
            navigate('/patient/myprofile')
  ...
  useEffect(()=>{
    ...
    const uploadImage = () => {
        ...
        axios
          .post(config.serverURL + `/employee/${sessionStorage['userId']}/images`, body, {
            headers: {
    ...
    return (
        <div className="col main  mt-3" style={{marginLeft:90, height:620, overflow:'auto'}}>
            <h2 className="mt-3 mb-3 text-secondary"style={{textAlign:"left"}}> Edit Profile </h2>
            <hr />
            ...
            <div className='mb-3'>
                    ...
                    type='file'
                    />
                    <button onClick={uploadImage} title='Upload Photo' className="btn btn-success m-1">Upload</button>
                </div>
                <div className="col-lg-5 col-md-6 col-sm-12">
                    ...
                    <div className='mb-3'>
                        ...
                        <input defaultValue={firstname}
                         ...
                         id="firstN" type="text" className="form-control" required />
                    </div>
                    ...
                    <div className='mb-3'>
                        ...
                        <input  defaultValue={lastname}
                         onChange={(e)=>setLastname(e.target.value)}
                          type="text" className="form-control" id="LName" required />
                    </div>
                    ...
                    <div className='mb-3'>
                        ...
                        <input  defaultValue={phone}
                         onChange={(e)=>setPhone(e.target.value)}
                          type="text" className="form-control" id="phone" required />
                    </div>
                    ...
                    <div className='mb-3'>
                        ...
                        <select defaultValue={bloodGroup}
                    ...
                    <div className='mb-3'>
                        ...
                        <input  defaultValue={dob} type='date'
                ...
                <div className="col-lg-5 col-md-6 col-sm-12">
                    ...
                    <div className='mb-3'>
                        ...
                        <input  defaultValue={buildingName}
                    ...
                    <div className='mb-3'>
                        ...
                        <input  defaultValue={securityQuestion}
                    ...
                    <div className='mb-3'>
                        ...
                        <input  defaultValue={securityAnswer}
                ...
                <div  className="row" >
                    <div className="col-lg-5 col-md-6 col-sm-12">
                        ...
                        <button onClick={editProfile}  className='btn btn-success' style={{marginTop:20}}>Update</button>
                         </div>  
                    </div>
                </div>

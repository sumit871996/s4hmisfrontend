...
const DocSidebar = (props) => {
  ...
  return (
    ...
    //       <Link className='nav-link text-secondary' to='/doctor/myDoctProfile'>
    //         <i className='far fa-folder font-weight-bold'></i>
    //         <span className='ml-3 text-white'>My Profile</span>
    //       </Link>
    //     </li>

    //     <li className='nav-item mb-2 '>
    //       <Link className='nav-link text-secondary' to='/doctor/dashboard'>
